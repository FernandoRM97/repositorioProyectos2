...
<body>
	...
	<p align="center">
		<a href="http://localhost:8080/springapp/filmografia/consultar"><input type="button"
			value="Otra Consulta"></a>
	</p>
	<p align="center">
		<a href="http://localhost:8080/springapp/filmografia/finalizar"><input type="button" value="Finalizar"></a>
	</p>
</body>
</html>